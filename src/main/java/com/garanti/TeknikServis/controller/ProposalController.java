...
public class ProposalController {
    ...
    public ResponseEntity save(@Validated BindingResult result, @RequestBody Proposal proposal, @RequestHeader HttpHeaders headers){
    ...
    public ResponseEntity getByUserOffers(@RequestHeader HttpHeaders headers){
    ...
    public ResponseEntity getByApprovedOffers(@RequestHeader HttpHeaders headers){
    ...
    @GetMapping("getById")
    @Secured(value = "ROLE_ADMIN")
    public ResponseEntity<?> getById(@Parameter (name = "id", required = true) @RequestParam("id") long id){
