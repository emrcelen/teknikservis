...
public class SaleController {
    ...
    public ResponseEntity< String > deleteById (@PathVariable (value = "id") Integer id,@RequestHeader HttpHeaders headers) {
        Locale locale = Locale.ENGLISH;
        if(headers.get("Accept-Language") != null) // swagger manuel optimizasyon.
            locale = new Locale(headers.get("Accept-Language").get(0).split(",")[0]);
    ...
    public ResponseEntity< String > save (@RequestBody Sale sale,@RequestHeader HttpHeaders headers) {
    ...
    public ResponseEntity getListofSales(@RequestHeader HttpHeaders headers){
        Locale locale = Locale.ENGLISH;
        if(headers.get("Accept-Language") != null) // swagger manuel optimizasyon.
            locale = new Locale(headers.get("Accept-Language").get(0).split(",")[0]);
    ...
    public ResponseEntity getListofSalesByProduct(@RequestParam(value = "type") String productType, @RequestHeader HttpHeaders headers){
        Locale locale = Locale.ENGLISH;
        if(headers.get("Accept-Language") != null) // swagger manuel optimizasyon.
            locale = new Locale(headers.get("Accept-Language").get(0).split(",")[0]);
    ...
    public ResponseEntity getListofSalesByProductId(@RequestParam(value = "product_id") Integer productId, @RequestHeader HttpHeaders headers){
        Locale locale = Locale.ENGLISH;
        if(headers.get("Accept-Language") != null) // swagger manuel optimizasyon.
            locale = new Locale(headers.get("Accept-Language").get(0).split(",")[0]);
