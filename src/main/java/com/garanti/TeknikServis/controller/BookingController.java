...
public class BookingController {
    ...
    public ResponseEntity getAppointmentsDatesInOrder(@RequestParam(name = "sortType") String type, @RequestHeader HttpHeaders headers){
    ...
    @Secured(value = "ROLE_ADMIN")
    public ResponseEntity getAllAppointmentLikeUsername (@RequestParam(name = "username") String username,@RequestHeader HttpHeaders headers){
    ...
    @Secured(value = "ROLE_ADMIN")
    public ResponseEntity<?> appointmentIsComplete(@RequestParam(name = "id") int id, @RequestParam (name = "is_done") boolean is_done,@RequestHeader HttpHeaders headers){
